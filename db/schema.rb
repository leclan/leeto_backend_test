...
ActiveRecord::Schema.define(version: 2020_02_26_111900) do
  ...
  create_table "perk_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["perk_id"], name: "index_perk_requests_on_perk_id"
    t.index ["user_id"], name: "index_perk_requests_on_user_id"
  end
